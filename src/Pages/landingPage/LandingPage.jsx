...
const WeatherDashboard = () => {
  ...
  // Show toast after a short delay, auto-hide when Achievement section is in view
  useEffect(() => {
    const showTimer = setTimeout(() => setToastVisible(true), 1500);

    // Watch for Achievement section entering viewport
    ...
    if (achievementEl) {
      ...
      observer.observe(achievementEl);
    }

    return () => {
      clearTimeout(showTimer);
      if (observer && achievementEl) observer.unobserve(achievementEl);
    };
  }, []);
  ...
  return (
    <div className="flex flex-col md:flex-row mt-24" style={{ backgroundColor: '#fefefe' }}>
      ...
      {!bannerDismissed && (
        <div
          className="fixed bottom-6 right-6 z-50 max-w-sm cursor-pointer group"
          style={{
        ...
        >
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #030455 0%, #0a0b6e 50%, #1a1b8e 100%)',
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(90deg, transparent 0%, rgba(249,248,113,0.5) 50%, transparent 100%)',
            ...
            <style>{`
              ...
              @keyframes pulse-glow {
                0%, 100% { box-shadow: 0 0 0 0 rgba(249, 248, 113, 0.3); }
                50% { box-shadow: 0 0 12px 4px rgba(249, 248, 113, 0.15); }
              }
            `}</style>
            ...
            <div className="relative flex items-start gap-3 p-4">
              ...
              <div
                ...
                style={{
                  backgroundColor: 'rgba(249, 248, 113, 0.15)',
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold tracking-wider uppercase" style={{ color: '#f9f871' }}>
                    2nd Prize Winner
                  </span>
                </div>
                <p className="text-xs leading-relaxed" style={{ color: '#e7fefe', opacity: 0.8 }}>
                  SNU HackNow India 2025 out of <span className="font-semibold" style={{ color: '#fefefe' }}>263+ teams</span> across India
                </p>
                <span
                  className="inline-flex items-center text-xs font-medium mt-2 group-hover:underline"
                  style={{ color: '#f9f871' }}
                >
                  View Achievement →
                </span>
              ...
              <button
                ...
                className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full hover:bg-white/10 transition-colors text-xs"
